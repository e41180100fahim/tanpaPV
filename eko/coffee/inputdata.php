...
if ($password == $pass2) {
$query = mysqli_query($koneksi, "INSERT INTO `customer` (`ID_Customer`, `Username`, `Password`, `Email`, `Nama`, `Alamat`, `No_Telepon`, `Scan_KTP`) VALUES (NULL, '$username', '$password', '$email', '$nama', '$alamat', '$no_telp', '$scan_ktp')");
