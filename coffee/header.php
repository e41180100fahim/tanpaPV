...
//$cek = $_SESSION['idcust'];
$result1 = mysqli_query($koneksi, "SELECT * FROM customer WHERE Username='".$_SESSION['username']."' AND ID_Customer='".$_SESSION['id']."'");
$row = mysqli_fetch_array($result1);

$result2 = mysqli_query($koneksi, "SELECT * FROM admin WHERE Username='".$_SESSION['username']."'");
$row2 = mysqli_fetch_array($result2);

$sql = mysqli_query($koneksi, "SELECT * FROM cart WHERE ID_Customer='".$row['ID_Customer']."'");
$aa = mysqli_num_rows($sql);

$count11 = mysqli_query($koneksi, "SELECT * FROM detail_transaksi WHERE ID_Customer='".$_SESSION['id']."' AND Status = 'Added to Cart'");
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            if ($row!="") { ?>
              <li class="nav-item cart"><a href="cart.php" class="nav-link"><span class="icon icon-shopping_cart"></span><span class="bag d-flex justify-content-center align-items-center"><small><?php echo $counting; ?></small></span></a></li>
            <?php
            }
            ?>
            ...
            <?php
            if ($row2!="") {
              echo '<li class="nav-item"><a href="pesanan.php" class="nav-link">Pesanan</a></li>';
              echo '<li class="nav-item"><a href="report.php" class="nav-link">Laporan</a></li>';
            }
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                elseif ($row2!="") {
                  echo '<a class="dropdown-item" href="profil.php"> Profil</a>'; ?>
                   <a class="dropdown-item" href="testlogout.php" onclick="return confirm('Yakin ingin logout?');">Log out</a>
                   <?php 
                  echo '<li class="nav-item"><a href="profiladmin.php" class="nav-link"> Hello '.$row2['Username'].'</a></li>';
