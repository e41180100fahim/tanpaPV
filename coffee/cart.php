    ...
    <section class="ftco-menu mb-5 pb-5">
	    				...
	    				<table class="table">
						    ...
						    <tbody style="background-color: #191919;">
						      ...
						      <tr class="text-center">
								...
								<input type="hidden" name="stock" id="stock" value="<?php echo $roww['Stock']; ?>">
		...
		<div class="row justify-content-end">
			<div class="col col-lg-4 col-md-6  cart-wrap ftco-animate">
					...
					<p style="background-color: #191919;" class="text-center"><input type="submit" value="Bayar Sekarang" class="btn btn-primary py-3 px-4"></p>
...
?>
  ...
  <script type="text/javascript">
	       function mySubmit(theForm,stock) {
	if(stock < theForm){
