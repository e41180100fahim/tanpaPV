...
<div class="login-wrap">
	<div class="login-html">
			<div class="head"></div>
			<div class="head-lnk">
			<div style="font-size: 36px; font"><a href="index.html">NINGPURI</a></div>
			</div>
			<br>
			<br>
			<br>
		...
		<div class="login-form">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					...
					<input id="nama" type="text" class="input">
				</div>
				<div class="group">
					<label for="alamat" class="label">Alamat</label>
					<input id="alamat" type="text" class="input">
				</div>
				<div class="group">
					<label for="telp" class="label">No Telepon</label>
					<input id="telp" type="text" class="input">
				</div>
				<div class="group">
					<label for="scan" class="label">Scan KTP</label>
					<input id="scan" type="text" class="input">
				</div>
				<div class="group">
					<input type="submit" class="button" value="Masuk">
				</div>
