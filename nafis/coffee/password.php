        ...
        <section class="module">
            <div class="module-inner">
                ...
                <div class="content-panel">
                    <h2 style="color: white;" class="title">Profil<span " class="pro-label label label-warning">GOLD</span></h2>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div style="margin-left: 13px ;" class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="email" name="katasandi" class="form-control" <?php echo 'value="'.$row['Password'].'"' ?> >
                                </div>
                            </div>
                            <div style="margin-left: 13px;" class="form-group">
