                ...
                <div class="row align-items-end">
	              ...
	              <div class="w-100"></div>
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" id="rupiah" name="harga" placeholder="" onkeypress="return hanyaAngka(event)" maxlength="14">
	                </div>
					</div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" name="stok" placeholder="" onkeypress="return hanyaAngka(event)" maxlength="14">
	                </div>
					</div>
