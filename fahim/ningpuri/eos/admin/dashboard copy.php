          ...
          <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="treeview-menu">
                  <li><a href="?page=img"><i class="fa fa-circle-o"></i> Image Slider</a></li>
           ...
           <li  <?php if (isset($_GET['page']) && $_GET['page'] == 'calonosis') { echo 'class="active"'; } ?>>
                <a href="?page=calonosis"><i class="	fa fa-mortar-board notif"></i> <span>Kandidat Osis<span id="notifikasi" class="label label-pill label-danger count" style="border-radius:10px;float:right;padding :0 10px;"><?php include "cekpesan.php" ?></span></span></a>
            </li>
