...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php if (isset($_GET["newpwd"])) {
                  if ($_GET["newpwd"] == "terupdate") {
                    echo '<div style="background:rgba(51,255,51,0.4);padding:10px 0px 1px 0px;text-align:center;color:black;"><p>Password Terupdate</p></div><br>';
                  }} ?>
